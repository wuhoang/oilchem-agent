...
| 模块 | 说明 | 状态 |
|------|------|------|
| 💬 智能对话 | SSE 流式对话、多会话管理、function calling 工具调用 | ✅ 可用 |
| 🔬 实验中心 | 方案库 → 一键实验 → 设备执行 → 自动出图 → 报告生成 → 追溯 | ✅ 可用 |
